...
const defectsData = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        prevention: 'Field sanitation, insect net, traps.',
      },
      {
        ...
        prevention: 'Maintain leaf cover, avoid over-pruning.',
      },
      {
      ...
      },
      {
        ...
        prevention: 'Keep soil moisture steady.',
      },
      {
        ...
        prevention: 'Pick at market maturity, store in cool area.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        prevention: 'Use insect netting or organic pest control.',
      },
      {
        name: 'Sunscald (Discoloration)',
        image: require('../assets/splash.png'),
      ...
      },
      {
        ...
        prevention: 'Keep watering consistent, avoid long dry-to-wet cycles.',
      },
      {
        ...
        prevention: 'Store and transport peppers at (7-10°C).',
      },
    ],
  },
];
